...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | 以下语言行包含验证器类使用的默认错误消息。这些规则中有一些有多个版本，
    | 例如大小规则。您可以自由地在这里调整每个消息。
    |
    */

    'accepted' => ':attribute 字段必须被接受。',
    'accepted_if' => '当 :other 是 :value 时，:attribute 字段必须被接受。',
    ...
    'dimensions' => ':attribute 字段有无效的图片尺寸。',
    'distinct' => ':attribute 字段有重复的值。',
    'doesnt_end_with' => ':attribute 字段不能以下列之一结束: :values。',
    'doesnt_start_with' => ':attribute 字段不能以下列之一开始: :values。',
    'email' => ':attribute 字段必须是一个有效的电子邮件地址。',
    'ends_with' => ':attribute 字段必须以下列之一结束: :values。',
    'enum' => '选定的 :attribute 无效。',
    'exists' => '选定的 :attribute 无效。',
    'extensions' => ':attribute 字段必须有以下扩展名之一: :values。',
    ...
    'mimes' => ':attribute 字段必须是一个以下类型的文件: :values。',
    'mimetypes' => ':attribute 字段必须是一个以下类型的文件: :values。',
    'min' => [
